...
from trilium_client.api_response import ApiResponse, T as ApiResponseT
import trilium_client.models
from trilium_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(trilium_client.models, klass)
