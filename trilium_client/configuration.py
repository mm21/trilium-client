...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "EtapiTokenAuth": APIKeyAuthSetting,
        "EtapiBasicAuth": BasicAuthSetting,
    },
    total=False,
)
...
class Configuration:
    ...
    conf = trilium_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("trilium_client")
    ...
    def auth_settings(self) -> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if "EtapiTokenAuth" in self.api_key:
            auth["EtapiTokenAuth"] = {
                "type": "api_key",
                "in": "header",
                "key": "Authorization",
